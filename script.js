document.addEventListener("DOMContentLoaded", () => {
  ...
  async function initializeProducts() {
     ...
     * }
     *
     * Тому новий сайт починається абсолютно порожнім.
     */
